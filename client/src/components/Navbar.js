      ...
      <div className="navbar-container">
        <div className="navbar-header">
          ...
          <button className="toggle-button" onClick={toggleSidebar}>
            ...
            {incompleteTasks > 0 && <Badge bg="danger">{incompleteTasks}</Badge>}
          </button>
        </div>
        <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
          <Nav defaultActiveKey="/dashboard" className="flex-column" onClick={closeSidebar}>
            ...
            <Nav.Link href="/tasks" className="nav-item">
              <i className="bi bi-alarm"></i> משימות {incompleteTasks > 0 && <Badge bg="danger">{incompleteTasks}</Badge>}
            </Nav.Link>
            <Nav.Link href="/training" className="nav-item">
              <i className="bi bi-bar-chart"></i> אימונים
            </Nav.Link>
            <Nav.Link href="/exericses" className="nav-item">
              <i className="bi bi-card-list"></i> מאגר תרגילים
            </Nav.Link>
            ...
            <Nav.Link href="/recipes" className="nav-item">
              <i className="bi bi-cookie"></i> מתכונים
            </Nav.Link>
            <Nav.Link href="/naturation-guides" className="nav-item">
              <i className="bi bi-file-richtext"></i> מדריכי תזונה
            </Nav.Link>
            <Nav.Link href="/courses" className="nav-item">
              <i className="bi bi-collection-play"></i> קורסים
            </Nav.Link>
